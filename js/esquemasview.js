...
function esqV2Html(e){
  ...
  return '<div class="esq2" data-s="' + esqEsc(e.subject) + '">' +
    ...
    '<p class="esq2-old"><button class="btn ghost" id="esqold">Ver el diagrama anterior</button></p></div>';
}
...
function drawEsq(){
  ...
  if (e.v2 && esqShowOld && !document.getElementById("esqnew")){
    ...
    st.insertAdjacentHTML("beforebegin", '<p class="esq2-old" id="esqnewwrap"><button class="btn ghost" id="esqnew">Ver el esquema nuevo</button></p>');
