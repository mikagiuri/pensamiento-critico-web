...
const DECK_SUBJECTS = { fil: "Filosofía 1.º", hf: "Historia de la Filosofía", ipc: "Pensamiento crítico" };
const DECK_BLOCKS = { A: "Bloque A · Antigua", B: "Bloque B · Medieval-Moderna", C: "Bloque C · Contemporánea" };
...
function drawCard(){
  ...
  kb.classList.toggle("on", on); kb.textContent = on ? "✓ Ya la sé" : "Ya la sé";
