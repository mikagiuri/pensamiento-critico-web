...
(function(){
  ...
  const EPOCAS = { antigua: "Antigua", medieval: "Medieval", moderna: "Moderna", contemporanea: "Contemporánea" };
  const CSS = ''
  ...
  function renderCitBody(){
    ...
    '<p class="citcount">' + list.length + (list.length === 1 ? " frase" : " frases") + '.</p>';
  }
